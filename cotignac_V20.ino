/**
 * @file cotignac_20.ino
 * @author Robin Emley (www.Mk2PVrouter.co.uk)
 * @author Frederic Metrich (frederic.metrich@live.fr)
 * @brief Mk2_3phase_RFdatalog_temp_1.ino - A photovoltaÃ¯c energy diverter.
 * @date 2020-01-14
 * 
 * @mainpage A 3-phase photovoltaÃ¯c router/diverter
 * 
 * @section description Description
 * Mk2_3phase_RFdatalog_temp_1.ino - Arduino program that maximizes the use of home photovoltaÃ¯c production
...
#ifdef TEMP_SENSOR
  int16_t temperature_times100; /**< temperature in 100th of Â°C */
#endif
};
...
#ifdef TEMP_SENSOR
/**
 * @brief Convert the internal value read from the sensor to a value in Â°C.
 * 
 */
...
void setup()
{
  ...
  Serial.println();
  Serial.println(F("----------------------------------"));
  Serial.println(F("Sketch ID:  cotignac_V20.ino"));
#endif
